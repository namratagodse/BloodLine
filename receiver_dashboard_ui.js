    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-4xl mx-auto mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4 px-4">
        <div>
          ...
          <select className="w-full border px-2 py-1 rounded text-xs">
        ...
        <div>
          ...
          <input type="number" min="1" className="w-full border px-2 py-1 rounded text-xs" />
        </div>
        <div>
      ...
      <div className="flex justify-center mt-6">
        <button
          ...
          className="text-white px-6 py-2 rounded hover:opacity-90 text-sm"
        >
          Search
        </button>
      </div>

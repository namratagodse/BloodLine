              ...
              {inventory.length > 0 ? (
                inventory.map((item) => (
                  <tr key={item.inventoryID}>
                    ...
                    <td>
                      {item.nextDonationDate
                        ? new Date(item.nextDonationDate).toLocaleDateString()
                        : "-"}
                    </td>    
                    <td>
                    {item.isAddedToInventory ? (
                        <span className="badge bg-success">Added</span>
                    ) : (
                        <span className="badge bg-danger">Not Added</span>
                    )}
                    </td>                  
                    </tr>
                ))

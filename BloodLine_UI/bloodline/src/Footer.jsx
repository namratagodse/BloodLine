...
function Footer() {
  return (
    <footer className="bg-dark text-white mt-5 py-4 border-top border-warning">
      <Container>
        <Row>
          {/* Column 1: About */}
          ...
          <Col md={4} className="mb-4 mb-md-0">
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="/center-login" className="text-white text-decoration-none d-block py-1">Blood Center Login</a></li>
              <li><a href="/donor-login" className="text-white text-decoration-none d-block py-1">Donor Login</a></li>
              <li><a href="/receiver-login" className="text-white text-decoration-none d-block py-1">Receiver Login</a></li>
            </ul>
          </Col>
